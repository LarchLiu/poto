...
<template>
  <el-form v-if="widgetOptions" size="small">
    ...
    <el-form-item label="样式">
      ...
      <el-radio-group v-model="widgetOptions.font.decoration" mt-1>
        <el-radio-button label="none">
          正常
        </el-radio-button>
        <el-radio-button label="underline">
          <span underline>下划线</span>
        </el-radio-button>
        <el-radio-button label="line-through">
          <span line-through>贯穿线</span>
        </el-radio-button>
        <el-radio-button label="overline">
          <span overline>上划线</span>
        </el-radio-button>
      </el-radio-group>
    </el-form-item>
