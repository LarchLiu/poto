...
export function createContext(options: Options = {}, root = process.cwd()) {
  ...
  function generateExport() {
    ...
    unimport.getImports().sort((a, b) => (a.as ?? a.name).localeCompare((b.as ?? b.name))).forEach((i) => {
      ...
      importStr += `  ${name}: { blockView: ${name}.blockView, blockSettingsView: ${name}.blockSettingsView, defaultSettings: ${name}.defaultSettings },\n`
    })

    const importObj = `export const blockPlugins = {\n${importStr}}\n`
